...
void View::agregarFigura() {
    int opcion;
    float longitudLado, base, altura, radio, lado, diagonalMenor, diagonalMayor, apotema;
    ...
    switch (opcion){
        ...
        case 3:{
            ...
            cin >> altura;
            programaObj->agregarFigura((float)base,(float)altura);// Importante el casteo para que se llame al metodo correcto
        }
        case 4:{
        ...
        case 5:{
            ...
            cin >> apotema;
            programaObj->agregarFigura((int)lado, (float)apotema);
        }
    }
}
